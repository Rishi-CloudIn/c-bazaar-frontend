...
@Component({
  selector: 'app-personal-docs-upload',
  templateUrl: './personal-docs-upload.component.html',
  styleUrls: ['./personal-docs-upload.component.css'],
})
export class PersonalDocsUploadComponent implements OnInit {
  ...
  // removePayslip(field1: any, field2: any, type: any) {
  ...
  // addForm16() {
  //   if (this.numArrayForm16.length < 3) {
  //     this.numArrayForm16.push(0);
  //     this.docsUploadForm.controls[
  //       'itrYear' + (this.numArrayForm16.length - 1)
  //     ].addValidators([Validators.required, Validators.pattern(/^[0-9 ]+$/)]);
  //     this.docsUploadForm.controls[
  //       'itr' + (this.numArrayForm16.length - 1)
  //     ].addValidators([Validators.required]);
  //   }
  // }

  // removeForm16() {
  //   if (this.numArrayForm16.length > 1) {
  //     this.numArrayForm16.splice(-1);
  //     this.docsUploadForm.controls[
  //       'itrYear' + (this.numArrayForm16.length - 1)
  //     ].removeValidators([
  //       Validators.required,
  ...
  // setForm16Array() {
  //   let data = [];
  //   for (let i = 0; i < this.numArrayForm16.length; i++) {
  //     data.push({
  //       url: this.docsUploadForm.controls['itr' + i].value,
  //       year: this.docsUploadForm.controls['itrYear' + i].value,
  //     });
  ...
  docsdata(field: any): FormArray {
    return this.docsUploadForm.get(field) as FormArray;
  }

  addDocs(field: any) {
    this.docsdata(field).push(this.docs());
  }
  deleteDocs(i: number, field: any) {
    this.docsdata(field).removeAt(i);
  }

  // getITRYears() {
  //   let year = this.itrYears;
  //   let itr1 = this.docsUploadForm.controls['itrYear1'].value;
  //   const result = this.itrYears.filter((year) => {
  //     year !== this.docsUploadForm.controls['itrYear0'].value &&
  //       year !== this.docsUploadForm.controls['itrYear1'].value &&
  //       year !== this.docsUploadForm.controls['itrYear2'].value;
  //   });
  //   return result;
  // }
  checkITRYear(i: number, year: any) {
    // this.docsUploadForm.controls['itr' + i].value;
    if (this.docsUploadForm.controls['itrYear0'].value == year) {
      return true;
    }
    return false;
