...
@Component({
  selector: 'app-dsa-application-personal-details',
  templateUrl: './dsa-application-personal-details.component.html',
  styleUrls: ['./dsa-application-personal-details.component.css'],
})
export class DsaApplicationPersonalDetailsComponent implements OnInit {
  id: string = '';
  tempId: string = '';
  loanType: string = '';
  data: any;
  ...
  getDetails() {
    ...
    this.app.applicationResolver(body).subscribe((r: any) => {
      ...
      if (r.role == 'dsa') {
        this.personalDetailsForm.controls['occupationType'].setValue(1);
        this.personalDetailsForm.controls['nomineeOccupationType'].setValue(1);
      }
